...
function wpt_portfolio_posttype() {
	...
	$labels = array(
		'name' => __( 'Portfolio', 'bird-portfolio' ),
		'singular_name' => __( 'Portfolio Item', 'bird-portfolio' ),
		'add_new' => __( 'Add New Item', 'bird-portfolio' ),
		'add_new_item' => __( 'Add New Portfolio Item', 'bird-portfolio' ),
		'edit_item' => __( 'Edit Portfolio Item', 'bird-portfolio' ),
		'new_item' => __( 'Add New Portfolio Item', 'bird-portfolio' ),
		'view_item' => __( 'View Item', 'bird-portfolio' ),
		'search_items' => __( 'Search Portfolio', 'bird-portfolio' ),
		'not_found' => __( 'No portfolio items found', 'bird-portfolio' ),
		'not_found_in_trash' => __( 'No portfolio items found in trash', 'bird-portfolio' )
	);
	...
	$taxonomy_portfolio_tag_labels = array(
		...
		'search_items' => _x( 'Search Portfolio Tags', 'bird-portfolio' ),
		'popular_items' => _x( 'Popular Portfolio Tags', 'bird-portfolio' ),
		'all_items' => _x( 'All Portfolio Tags', 'bird-portfolio' ),
		'parent_item' => _x( 'Parent Portfolio Tag', 'bird-portfolio' ),
		'parent_item_colon' => _x( 'Parent Portfolio Tag:', 'bird-portfolio' ),
		'edit_item' => _x( 'Edit Portfolio Tag', 'bird-portfolio' ),
		'update_item' => _x( 'Update Portfolio Tag', 'bird-portfolio' ),
		'add_new_item' => _x( 'Add New Portfolio Tag', 'bird-portfolio' ),
		'new_item_name' => _x( 'New Portfolio Tag Name', 'bird-portfolio' ),
		'separate_items_with_commas' => _x( 'Separate portfolio tags with commas', 'bird-portfolio' ),
		'add_or_remove_items' => _x( 'Add or remove portfolio tags', 'bird-portfolio' ),
    ...
    $taxonomy_portfolio_category_labels = array(
		'name' => _x( 'Portfolio Categories', 'bird-portfolio' ),
		'singular_name' => _x( 'Portfolio Category', 'bird-portfolio' ),
		'search_items' => _x( 'Search Portfolio Categories', 'bird-portfolio' ),
		'popular_items' => _x( 'Popular Portfolio Categories', 'bird-portfolio' ),
		'all_items' => _x( 'All Portfolio Categories', 'bird-portfolio' ),
		'parent_item' => _x( 'Parent Portfolio Category', 'bird-portfolio' ),
		'parent_item_colon' => _x( 'Parent Portfolio Category:', 'bird-portfolio' ),
		'edit_item' => _x( 'Edit Portfolio Category', 'bird-portfolio' ),
		'update_item' => _x( 'Update Portfolio Category', 'bird-portfolio' ),
		'add_new_item' => _x( 'Add New Portfolio Category', 'bird-portfolio' ),
		'new_item_name' => _x( 'New Portfolio Category Name', 'bird-portfolio' ),
		'separate_items_with_commas' => _x( 'Separate portfolio categories with commas', 'bird-portfolio' ),
		'add_or_remove_items' => _x( 'Add or remove portfolio categories', 'bird-portfolio' ),
...
function portfolioposttype_edit_columns($portfolio_columns){
	$portfolio_columns = array(
		...
		"thumbnail" => __('Thumbnail', 'bird-portfolio'),
		"portfolio_category" => __('Category', 'bird-portfolio'),
		"portfolio_tag" => __('Tags', 'bird-portfolio'),
		"author" => __('Author', 'bird-portfolio'),
		"comments" => __('Comments', 'bird-portfolio'),
		"date" => __('Date', 'bird-portfolio'),
	);
